...
public class XueyaDataActivity extends AppCompatActivity {
    ...
    public static String XueyaName;
    ...
    private void initDateUser() {
        ...
        XueyaName=extras.getString("username");
    ...
    private void initFragment(){
        ...
        Fragment f1=new FragmentRecord_XueYa();
        Fragment f2=new FragmentTendency_XueYa();
    ...
    private void initTopUI() {
        ...
        viewPager = (ViewPager) findViewById(R.id.vp_content_xueya);
    ...
    private void initTopTabBar() {
        ...
        navigationTabBar= (NavigationTabBar) findViewById(R.id.ntb_xueya);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.data_putin:
                Intent addIntent=new Intent(this,XueYaPutInActivity.class);
            ...
            case R.id.data_clean:
                ...
                builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        db.delete("xueyaData","name=?",new String[]{"机主"});
                        db.close();
                    }
                });
