...
import com.fanny.healthcareclient.fragment.FragmentRecord_XueTang;
import com.fanny.healthcareclient.fragment.FragmentRecord_XueYang;
import com.fanny.healthcareclient.fragment.FragmentTendency_XueTang;
...
public class XueYangDataActivity extends AppCompatActivity {
    ...
    public static String XueyangName;
    ...
    private void initDateUser() {
        ...
        XueyangName=extras.getString("username");
    ...
    private void initFragment(){
        ...
        Fragment f1=new FragmentRecord_XueYang();
        Fragment f2=new FragmentTendency_XueYang();
    ...
    private void initTopUI() {
        ...
        viewPager = (ViewPager) findViewById(R.id.vp_content_xueyang);
    ...
    private void initTopTabBar() {
        ...
        navigationTabBar= (NavigationTabBar) findViewById(R.id.ntb_xueyang);
        ArrayList<NavigationTabBar.Model> models = new ArrayList<>();
        models.add(new NavigationTabBar.Model.Builder(null,Color.parseColor(colors[3]))
                .title("纪录").build());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.data_putin:
                Intent addIntent=new Intent(this,XueYangPutInActivity.class);
            ...
            case R.id.data_clean:
                ...
                builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        db.delete("xueyangData","name=?",new String[]{"机主"});
                        db.close();
                    }
                });
