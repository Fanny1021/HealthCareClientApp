...
import com.fanny.healthcareclient.fragment.FragmentRecord_ECG;
import com.fanny.healthcareclient.fragment.FragmentRecord_Temp;
import com.fanny.healthcareclient.fragment.FragmentTendency_ECG;
...
public class ECGDataActivity extends AppCompatActivity {
    ...
    private void initDateUser() {
        ...
        ECGName=extras.getString("username");
    }
    ...
    private void initFragment(){
        ...
        Fragment f1=new FragmentRecord_ECG();
        Fragment f2=new FragmentTendency_ECG();
    ...
    private void initTopUI() {
        ...
        viewPager = (ViewPager) findViewById(R.id.vp_content_ecg);
    ...
    private void initTopTabBar() {
        ...
        navigationTabBar= (NavigationTabBar) findViewById(R.id.ntb_ecg);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.data_putin:
                Intent addIntent=new Intent(this,ECGPutInActivity.class);
            ...
            case R.id.data_clean:
                ...
                builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        db.delete("xindianData","name=?",new String[]{"机主"});
                        db.close();
                    }
                });
