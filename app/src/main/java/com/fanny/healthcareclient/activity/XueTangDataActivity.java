...
public class XueTangDataActivity extends AppCompatActivity {

    private String TAG = "XuetangActivity";
    ...
    public static String XuetangName;
    ...
    private void initDateUser() {
        ...
        XuetangName=extras.getString("username");
    ...
    private void initFragment(){
        ...
        Fragment f1=new FragmentRecord_XueTang();
        Fragment f2=new FragmentTendency_XueTang();
    ...
    private void initTopUI() {
        ...
        viewPager = (ViewPager) findViewById(R.id.vp_content_xuetang);
    ...
    private void initTopTabBar() {
        ...
        navigationTabBar= (NavigationTabBar) findViewById(R.id.ntb_xuetang);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.data_putin:
                Intent addIntent=new Intent(this,XueTangPutInActivity.class);
            ...
            case R.id.data_clean:
                ...
                builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        db.delete("xuetangData","name=?",new String[]{"机主"});
                        db.close();
                    }
                });
